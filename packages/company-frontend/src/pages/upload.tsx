import { Button, Container, FormControl, FormLabel, Heading, Input, NumberDecrementStepper, NumberIncrementStepper, NumberInput, NumberInputField, NumberInputStepper, Select, SimpleGrid, Tag, TagCloseButton, TagLabel, useToast, VStack } from '@chakra-ui/react';
...
const UploadPage: React.FC = () => {
    ...
    const sendProduct = async (data: Product): Promise<void> => {
    ...
    const handleFile = (file: string, filename: string): void => {
    ...
    const handleRemoveButtonClick = (uid: string): void => {
            ...
            <Layout>
                <div style={{ flex: '1 0 auto' }}>
                    ...
                    <Container maxW='container.md'>
                        <form onSubmit={handleSubmit((data: Product) => sendProduct(data))}>
                            <SimpleGrid gap={5}>
                                <FormControl>
